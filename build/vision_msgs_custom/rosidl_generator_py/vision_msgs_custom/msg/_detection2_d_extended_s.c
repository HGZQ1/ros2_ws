...
bool vision_msgs_custom__msg__detection2_d_extended__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs_custom.msg._detection2_d_extended.Detection2DExtended", full_classname_dest, 65) == 0);
  }
  vision_msgs_custom__msg__Detection2DExtended * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Detection2DExtended */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs_custom.msg._detection2_d_extended");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Detection2DExtended");
