...
bool vision_msgs_custom__msg__object_distance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs_custom.msg._object_distance.ObjectDistance", full_classname_dest, 54) == 0);
  }
  vision_msgs_custom__msg__ObjectDistance * ros_message = _ros_message;
  {  // header
...
PyObject * vision_msgs_custom__msg__object_distance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs_custom.msg._object_distance");
