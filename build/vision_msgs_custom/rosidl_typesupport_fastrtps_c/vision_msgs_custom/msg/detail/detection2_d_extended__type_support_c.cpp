...
#include "vision_msgs_custom/msg/detail/detection2_d_extended__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs_custom/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_vision_msgs_custom
...
using _Detection2DExtended__ros_msg_type = vision_msgs_custom__msg__Detection2DExtended;

static bool _Detection2DExtended__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Detection2DExtended__ros_msg_type * ros_message = static_cast<const _Detection2DExtended__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _Detection2DExtended__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Detection2DExtended__ros_msg_type * ros_message = static_cast<_Detection2DExtended__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs_custom
size_t get_serialized_size_vision_msgs_custom__msg__Detection2DExtended(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection2DExtended__ros_msg_type * ros_message = static_cast<const _Detection2DExtended__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Detection2DExtended__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs_custom__msg__Detection2DExtended(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs_custom
size_t max_serialized_size_vision_msgs_custom__msg__Detection2DExtended(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs_custom__msg__Detection2DExtended;
    is_plain =
      (
      offsetof(DataType, position_3d) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Detection2DExtended__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_vision_msgs_custom__msg__Detection2DExtended(
...
static message_type_support_callbacks_t __callbacks_Detection2DExtended = {
  "vision_msgs_custom::msg",
  "Detection2DExtended",
  _Detection2DExtended__cdr_serialize,
  _Detection2DExtended__cdr_deserialize,
  _Detection2DExtended__get_serialized_size,
  _Detection2DExtended__max_serialized_size
};

static rosidl_message_type_support_t _Detection2DExtended__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Detection2DExtended,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_msgs_custom, msg, Detection2DExtended)() {
  return &_Detection2DExtended__type_support;
}
