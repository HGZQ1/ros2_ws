...
#include "vision_msgs_custom/msg/detail/object_distance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_msgs_custom::msg::ObjectDistance & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_msgs_custom::msg::ObjectDistance & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs_custom::msg::ObjectDistance;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_msgs_custom::msg::ObjectDistance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_msgs_custom::msg::ObjectDistance *>(
    untyped_ros_message);
...
{
  return &vision_msgs_custom::msg::typesupport_fastrtps_cpp::_ObjectDistance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs_custom, msg, ObjectDistance)() {
  return &vision_msgs_custom::msg::typesupport_fastrtps_cpp::_ObjectDistance__handle;
}
